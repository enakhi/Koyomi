...
final class KoyomiCell: UICollectionViewCell {
    ...
    func configureAppearanse(of style: CellStyle, withColor color: UIColor, backgroundColor: UIColor, isSelected: UIColor?) {
        if let color = isSelected {
            circularView.backgroundColor = color.withAlphaComponent(0.1)
        ...
        case .standard:
            ...
            circularView.isHidden  = isSelected == nil
...
private extension KoyomiCell {
    ...
    func configureCircularView() {
        circularView.frame=bounds.insetBy(dx: 2, dy: 2)
        circularView.layer.borderWidth=1
        circularView.layer.cornerRadius = 5
        circularView.backgroundColor = .orange.withAlphaComponent(0.1)
        circularView.layer.borderColor = UIColor.orange.cgColor
